...
import { NIGHT_EFFECT } from "@/config/effects";
import { NIGHT_FLOWERS } from "@/constants/emojis";
...
const NightGarden = () => (
  ...
  >
    ...
    {Array.from({ length: 15 }).map((_, i) => (
      <div
        ...
        style={{
          ...
          animation: `fireflyDance ${4 + Math.random() * 3}s ease-in-out infinite ${
            Math.random() * 2
          }s`,
        }}
      />
    ...
    {Array.from({ length: 6 }).map((_, i) => (
      <div
        ...
        style={{
          ...
          top: `${Math.random() * 100}%`,
          fontSize: "18px",
          animation: `mothFlight ${5 + Math.random() * 3}s ease-in-out infinite ${
            Math.random() * 2
          }s`,
    ...
    <AnimatedOverlay config={NIGHT_EFFECT} zIndex={2} />
  </div>
);

export default function MoonGardenTransition() {
  const nightGardenElements = NIGHT_FLOWERS;
    ...
    >
      ...
      {Array.from({ length: 15 }).map((_, i) => (
        <div
          ...
          style={{
            ...
            animation: `nightCelebration ${3 + Math.random() * 2}s ease-in-out infinite`,
            animationDelay: `${Math.random() * 2}s`,
            zIndex: 1,
            filter: "drop-shadow(0 0 8px rgba(255, 249, 196, 0.3))",
          }}
        >
          {nightGardenElements[Math.floor(Math.random() * nightGardenElements.length)]}
        </div>
      ))}
      ...
      <div
        style={{
          ...
          zIndex: 10,
          animation: "moonlitGlow 3s ease-in-out infinite alternate",
      ...
      >
        ...
        <div
          style={{
            fontSize: "24px",
            animation: "nightGardenDance 4s ease-in-out infinite",
            filter: "drop-shadow(0 0 8px rgba(255, 249, 196, 0.3))",
          }}
        >
          🌙 💕 🌸 ⭐ 🌙
