...
export default function MessageBox({
	...
	message = 'Heyyy ❤️…<br><br>Just a gentle reminder: මෙතන තියන <b>කිසිම දෙයක් AI Generated <span style="color:red">නෙවෙයි</span></b> — except a few tiny CSS styles and some English grammar quirks 🥴.<br><br>මේ හැමදේම හදන එක අමාරු වුණා, but I poured my heart into every bit… just for you 🌸✨.<br><br>මෙතන තියන හැමදේම click කරලා බලන්න na, because every little part carries a piece of me 💖.<br><br><span style="color:#ff69b4"><b>Note:</b> හැමදේම හරියටම බලන්න බැරිවෙයි phone එකෙන් 😔. Try to use a laptop or a bigger display for the full experience! 💻🌈</span><br><br><b>"I may not be cute… but I poured my heart into this little web app 💻💞 I hope it feels a little cute to Youuuu 🥺🌷"</b><br><br>Stay magical, keep shining bright like you always do! ✨🌟',
}) {
